...
Cette page fut mise à jour pour la dernière fois le 26 Août 2022.

## Introducion

Ceci est le site web personnel de Lucien Cartier-Tilet.
...
serveurs loués à Scalaway et à OVH France respectivement, et les
...
site. Bien que tous les sites n’en font pas forcément usage, ils sont
néamoins extrêmement répandus afin de permettre aux sites de
fonctionner correctement ou plus efficacement.

Ce site utilise quelques cookies fonctionnels afin de se remémorer vos
préférences, comme la langue du site ou bien son thème. Ces cookies ne
sont pas et ne peuvent pas être utilisés pour vous traquer.
...
enregistrer le traffique sur le site.
...
personellement [uBlock Origin](https://ublockorigin.com/), l’un des
bloqueurs de pub les plus efficace que je connaisse.
...
changements de fonctionnement du site. Il se peut aussi que j’ajoute
un jour un tracking des utilisateurs sur mon site via Matomo, un
service de tracking respectant la vie privée des utilisateurs et qui
est tout à fait bloquable. La date de la derniène mise à jour de cette
page peut être trouvée à son tout début.
